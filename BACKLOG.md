...
#### **Tareas**
- [ ] **Tarea 1.1**: Actualizar Header para mostrar información del usuario
...
- [ ] **Tarea 1.3**: Añadir confirmación de logout
...
- [ ] Dashboard muestra información personalizada del usuario
...
#### **Tareas**
- [ ] **Tarea 2.1**: Crear página de Reset Password
  - Formulario para solicitar reset por email
  - Validación de email
  - Estados de loading y confirmación
  
- [ ] **Tarea 2.2**: Crear página de New Password
  - Formulario para establecer nueva contraseña
  - Validación de tokens de reset
  - Confirmación de contraseña

- [ ] **Tarea 2.3**: Agregar navegación entre páginas
...
|--------|-----------|------------|--------|--------|-----|
| Sprint 1: UX Inmediata | 🚨 Alta | 45 min | ⏳ Pendiente | - | - |
| Sprint 2: Reset Password | 🔶 Media-Alta | 30 min | ⏳ Pendiente | - | - |
